...
mnist: ${MNIST_SRC}
	GOOS=js GOARCH=wasm ${GC} build -o ${APP_STATIC_DIR}/mnist.wasm ${MNIST_DIR}

mnist-cnn: ${MNIST_CNN_SRC}
	GOOS=js GOARCH=wasm ${GC} build -o ${APP_STATIC_DIR}/mnist-cnn.wasm ${MNIST_CNN_DIR}

wasm-exec-js:
	cp "$(shell ${GC} env TINYGOROOT)/targets/wasm_exec.js" ${APP_STATIC_DIR}
...
clean:
	rm -f ${APP_STATIC_DIR}/mnist.wasm ${APP_STATIC_DIR}/mnist-cnn.wasm ${APP_STATIC_DIR}/wasm_exec.js
	rm -rf ${APP_DIR}/build
